...
Parsed_Procedure_Parameter *Parsed_Procedure_Parameter__create(Token *name, Parsed_Type *type) {
...
Parsed_Type_Expression *Parsed_Type_Expression__create(Source_Location location, Parsed_Type *type) {
    Parsed_Type_Expression *expression = (Parsed_Type_Expression *)Parsed_Expression__create_kind(PARSED_EXPRESSION_KIND__TYPE, sizeof(Parsed_Type_Expression), location);
    expression->type = type;
    return expression;
}
...
Parsed_Statement *Parsed_Procedure_Statement__create(Source_Location location, Token *name, bool is_method, Parsed_Procedure_Parameter *first_parameter, Parsed_Type *return_type, bool is_external, Parsed_Block_Statement *block_statement, String_Token *external_name) {
...
Parsed_Type_Statement *Parsed_Type_Statement__create(Source_Location location, Token *name, Parsed_Type_Specifier *type_specifier) {
