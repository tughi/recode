...
typedef struct Parsed_Type_Alignment_Expression {
    Parsed_Expression super;
    Parsed_Type *type;
} Parsed_Type_Alignment_Expression;
...
Parsed_Statement *Parsed_Procedure_Statement__create(Source_Location location, Token *name, bool is_method, Parsed_Procedure_Parameter *first_parameter, Parsed_Type *return_type, bool is_external, struct Parsed_Block_Statement *block_statement, String_Token *external_name);
