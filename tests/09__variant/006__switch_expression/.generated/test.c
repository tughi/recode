...
#line 11 "tests/09__variant/006__switch_expression/test.code"
int32_t test__main() {
#line 12 "tests/09__variant/006__switch_expression/test.code"
    struct test_Literal literal = (struct test_Literal){.value = (struct test_Value){.variant = 3, .variant_3 = 42}};
#line 13 "tests/09__variant/006__switch_expression/test.code"
