...
#line 11 "tests/09__variant/006__switch_else_only/test.code"
int32_t test__main() {
#line 12 "tests/09__variant/006__switch_else_only/test.code"
    struct test_Value value = (struct test_Value){.variant = 2, .variant_2 = (struct test_Integer){.variant = 2, .variant_2 = 42}};
#line 14 "tests/09__variant/006__switch_else_only/test.code"
