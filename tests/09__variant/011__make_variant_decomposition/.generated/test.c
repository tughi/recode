...
#line 23 "tests/09__variant/011__make_variant_decomposition/test.code"
        {
#line 23 "tests/09__variant/011__make_variant_decomposition/test.code"
            int32_t __002__ = test__evaluate__expression(__switch_18_value__.variant_2->left) + test__evaluate__expression(__switch_18_value__.variant_2->right);
#line 23 "tests/09__variant/011__make_variant_decomposition/test.code"
            return __002__;
#line 23 "tests/09__variant/011__make_variant_decomposition/test.code"
        }
...
#line 26 "tests/09__variant/011__make_variant_decomposition/test.code"
        {
#line 26 "tests/09__variant/011__make_variant_decomposition/test.code"
            int32_t __003__ = test__evaluate__expression(__switch_18_value__.variant_3->left) - test__evaluate__expression(__switch_18_value__.variant_3->right);
#line 26 "tests/09__variant/011__make_variant_decomposition/test.code"
            return __003__;
#line 26 "tests/09__variant/011__make_variant_decomposition/test.code"
        }
...
#line 38 "tests/09__variant/011__make_variant_decomposition/test.code"
        int32_t __006__ = test__evaluate__expression(__005__);
#line 38 "tests/09__variant/011__make_variant_decomposition/test.code"
        return __006__;
