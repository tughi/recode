...
#line 46 "tests/99__calculator/test.code"
        return test__evaluate__0_expression(__switch_41_value__->variant_2.left) + test__evaluate__0_expression(__switch_41_value__->variant_2.right);
    }
#line 48 "tests/99__calculator/test.code"
    else if (__switch_41_value__->variant == 3) {
#line 49 "tests/99__calculator/test.code"
        return test__evaluate__0_expression(__switch_41_value__->variant_3.left) / test__evaluate__0_expression(__switch_41_value__->variant_3.right);
    }
#line 51 "tests/99__calculator/test.code"
    else if (__switch_41_value__->variant == 4) {
#line 52 "tests/99__calculator/test.code"
        return test__evaluate__0_expression(__switch_41_value__->variant_4.left) * test__evaluate__0_expression(__switch_41_value__->variant_4.right);
    }
#line 54 "tests/99__calculator/test.code"
    else if (__switch_41_value__->variant == 5) {
#line 55 "tests/99__calculator/test.code"
        return test__evaluate__0_expression(__switch_41_value__->variant_5.left) - test__evaluate__0_expression(__switch_41_value__->variant_5.right);
    }
