...
#line 12 "tests/99__calculator/io/writer.code"
        pio_Writer__write__char(self, string_data[index]);
...
#line 26 "tests/99__calculator/io/writer.code"
        pio_Writer__write__char(self, '-');
#line 27 "tests/99__calculator/io/writer.code"
        {
#line 27 "tests/99__calculator/io/writer.code"
            struct io_Writer *__001__ = pio_Writer__write_signed__signed(self, -value);
#line 27 "tests/99__calculator/io/writer.code"
            return __001__;
#line 27 "tests/99__calculator/io/writer.code"
        }
...
#line 30 "tests/99__calculator/io/writer.code"
        pio_Writer__write_signed__signed(self, value / 10);
#line 31 "tests/99__calculator/io/writer.code"
    }
#line 32 "tests/99__calculator/io/writer.code"
    {
#line 32 "tests/99__calculator/io/writer.code"
        struct io_Writer *__002__ = pio_Writer__write__char(self, ((uint8_t) (value % 10)) + '0');
#line 32 "tests/99__calculator/io/writer.code"
        return __002__;
#line 32 "tests/99__calculator/io/writer.code"
    }
