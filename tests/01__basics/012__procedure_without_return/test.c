...
#line 6 "tests/01__basics/012__procedure_without_return/test.code"
    test__finish();
#line 7 "tests/01__basics/012__procedure_without_return/test.code"
    return 1;
}
...
#line 11 "tests/01__basics/012__procedure_without_return/test.code"
    test__nothing();
#line 12 "tests/01__basics/012__procedure_without_return/test.code"
    exit(0);
}

#line 15 "tests/01__basics/012__procedure_without_return/test.code"
void test__nothing() {
}
