...
#line 3 "tests/01__basics/024__call_procedure_pointer_variable/test.code"
int32_t test__main() {
...
#line 6 "tests/01__basics/024__call_procedure_pointer_variable/test.code"
    return echo_pointer(42) - 42;
}

#line 9 "tests/01__basics/024__call_procedure_pointer_variable/test.code"
int32_t test__echo__0_value(int32_t value) {
#line 10 "tests/01__basics/024__call_procedure_pointer_variable/test.code"
    return value;
}
