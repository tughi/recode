...
#line 3 "tests/01__basics/022__assign_procedure_pointer_variable/test.code"
int32_t test__main() {
...
#line 8 "tests/01__basics/022__assign_procedure_pointer_variable/test.code"
    return 0;
}

#line 11 "tests/01__basics/022__assign_procedure_pointer_variable/test.code"
int32_t test__echo__0_value(int32_t value) {
#line 12 "tests/01__basics/022__assign_procedure_pointer_variable/test.code"
    return value;
}
