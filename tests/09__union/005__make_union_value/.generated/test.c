...
#line 12 "tests/09__union/005__make_union_value/test.code"
    struct test__Value value = (struct test__Value){.variant = 2, .variant_2 = (struct test__Integer){.variant = 2, .variant_2 = 256}};
#line 13 "tests/09__union/005__make_union_value/test.code"
    value = (struct test__Value){.variant = 2, .variant_2 = (struct test__Integer){.variant = 2, .variant_2 = 42}};
