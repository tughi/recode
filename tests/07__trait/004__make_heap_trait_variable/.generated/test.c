...
#line 23 "tests/07__trait/004__make_heap_trait_variable/test.code"
    struct test_Shape *square_shape = __alloc__test_Shape__((struct test_Shape){.self = square, .area = ((int32_t (*)(void *self)) test__pSquare__area)});
...
#line 25 "tests/07__trait/004__make_heap_trait_variable/test.code"
    struct test_Shape *circle_shape = __alloc__test_Shape__((struct test_Shape){.self = circle, .area = ((int32_t (*)(void *self)) test__pCircle__area)});
