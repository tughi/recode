...
#line 5 "tests/03__unchecked_array/004__access_with_index_variable/test.code"
    int32_t i = 1;
#line 6 "tests/03__unchecked_array/004__access_with_index_variable/test.code"
    if (argv[i][i] != '0') {
#line 7 "tests/03__unchecked_array/004__access_with_index_variable/test.code"
        return 2;
    }
#line 9 "tests/03__unchecked_array/004__access_with_index_variable/test.code"
    return 0;
}
